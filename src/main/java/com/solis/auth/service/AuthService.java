package com.solis.auth.service;

import com.solis.auth.api.dto.*;
import com.solis.auth.audit.LoginLogService;
...
import com.solis.auth.token.RefreshTokenStore;
import com.solis.auth.token.TokenPair;
import com.solis.auth.util.IdentifierValidator;
import com.solis.auth.verification.*;
...
import com.solis.user.service.UserService;
...
public class AuthService {
    ...
    public AuthResponse register(RegisterRequest request, ClientInfo clientInfo) {
        ...
        User user = User.builder()
                ...
                .avatar("https://yourimageshare.com/ib/mvbHPZznhs.png")
                .bio(null)
                .tagsJson("[]")
                .build();
    ...
    private String generateNickname() {
        return "zhiHub用户" + UUID.randomUUID().toString().substring(0, 8);
    }
