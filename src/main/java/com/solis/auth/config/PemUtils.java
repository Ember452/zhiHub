...
public final class PemUtils {
    ...
    //PEM 文件的标准头尾标识，分别对应 PKCS#8 私钥和 X.509 公钥格式。
    ...
    public static RSAPrivateKey readPrivateKey(Resource resource) {
        try {
            ...
            // RSA 私钥标准格式是 PKCS#8 这个类表示 “PKCS8 格式的密钥编码”
            PKCS8EncodedKeySpec spec = new PKCS8EncodedKeySpec(keyBytes);
            //KeyFactory 秘钥翻译器，把二进制秘钥转换成java可以看懂的密钥对象
     ...
     * 把一个PEM格式的RSA 公钥文件 读进来，洗干净，转换成java能识别使用的RSAPublicKey对象。
